...
```
The reload-and-verify-progress is the iPad-over-LAN smoke per CLAUDE.md Pillar 3 (IDB-first state) — losing progress on a hot reload is the primary failure mode this skill exists to catch.
